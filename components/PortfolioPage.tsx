        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          {filteredItems.map((item, idx) => (
            <div 
              ...
              className="bg-slate-50 border border-slate-100 p-8 rounded-[2rem] group hover:bg-white hover:shadow-2xl transition-all cursor-pointer"
            >
              ...
              <div className="h-56 w-full bg-white rounded-2xl overflow-hidden border border-slate-100 flex items-center justify-center relative shadow-inner">
                ...
                <div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                   <div className="bg-[#0A3D62] p-2 rounded-lg text-white shadow-lg">
